...
include "../clases/ConexionBD.php";
	...
	if (!empty($_POST)) 
	{
		...
		$query_restore=mysqli_query($conexionbd,"UPDATE categorias SET estado=1 WHERE id_categoria=$id_categoria");
		mysqli_close($conexionbd);
	if ($query_restore) {
		header("location: lista_categoria.php");
		mysqli_close($conexionbd);
...
<head>
	...
	<title>Restaurar categoría</title>
	...
	<section id="container">
		...
		<div class="data_delete">
			...
			<form method="post" action="">
				...
				<a href="lista_categoria.php"><button  style="margin: 30px auto 5px auto" class="btn btn-success" ><i class="fas fa-trash-restore"></i> Restaurar</button>
				</a>
