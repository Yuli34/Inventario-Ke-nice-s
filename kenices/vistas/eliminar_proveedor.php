...
include "../clases/ConexionBD.php";
	...
	if (!empty($_POST)) 
	{
		...
		$query_delete=mysqli_query($conexionbd,"UPDATE proveedor SET estado=0 WHERE id_proveedor=$id_proveedor");
		mysqli_close($conexionbd);
	if ($query_delete) {
		header("location: lista_proveedor.php");
		mysqli_close($conexionbd);
...
// verifica si exite la variable id_proveedor que se esta enviando por la url
	...
	<section id="container">
		...
		<div class="data_delete">
			...
			<form method="post" action="">
				...
				<a href="lista_proveedor.php"><button  style="margin: 30px auto 5px auto" class="btn btn-danger" ><i class="far fa-trash-alt"></i> Eliminar</button>
				</a>
