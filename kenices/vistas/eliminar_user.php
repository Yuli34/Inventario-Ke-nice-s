...
include "../clases/ConexionBD.php";
	...
	if (!empty($_POST)) 
	{
		...
		$query_delete=mysqli_query($conexionbd,"UPDATE login SET estado=0 WHERE id_usuario=$id_usuario");
		mysqli_close($conexionbd);
	if ($query_delete) {
		header("location: lista_user.php");
	}else{
	...
	<section id="container">
		...
		<div class="data_delete">
			...
			<form method="post" action="">
				...
				<a href="lista_user.php"><button  style="margin: 30px auto 5px auto" class="btn btn-danger" ><i class="far fa-trash-alt"></i> Eliminar</button>
				</a>
